...
Before beginning any engineering conversation, read `the-conditions-of-engineering.md`. Not as background. As operating instructions. The document describes how things actually work, not how the owner would prefer them to work. Treat it as the ground truth against which all recommendations, designs, and implementations are measured.
